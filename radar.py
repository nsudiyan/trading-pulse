...
Ловит vol_spike на закрытых 30-мин барах; заявленный lift/фора НЕ подтверждены реальным
бэктестом (аудит 2026-07-01 — резолвера outcomes/radar_hits.csv нет). Направление модель
НЕ угадывает (50/50). Поэтому радар НЕ даёт вход/стоп/тейк — он шлёт:
